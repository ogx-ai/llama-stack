...
description: Open-source AI application server. Inference, vector stores, tools, and agentic orchestration in one process.
sidebar_label: Intro
tags:
  - getting-started
  - overview
...
<DocCardList items={[
  ...
  },
  {
    ...
    label: 'Providers',
    href: '/docs/providers/',
    description: 'Inference, vector store, file, and tool providers',
  },
  {
    type: 'link',
    label: 'Core Concepts',
