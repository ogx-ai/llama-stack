...
For additional information about testing, please refer to the [tests documentation](https://github.com/ogx-ai/ogx/blob/main/tests/README.md) for both unit and integration test.
...
2. **Present at a community call** (optional): Bring your proposal to a [community call](https://github.com/ogx-ai/ogx#community) to gather feedback, answer questions, and build consensus with other contributors and maintainers.
...
For information about how OGX versions are released, including release schedules, testing requirements, and how to contribute to releases, see [RELEASE_PROCESS.md](https://github.com/ogx-ai/ogx/blob/main/RELEASE_PROCESS.md).
